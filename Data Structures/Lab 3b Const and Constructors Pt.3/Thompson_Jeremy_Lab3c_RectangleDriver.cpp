...
//"Lab 3c, The \"RectangleDriver.cpp\" Program \n";
...
#include "Thompson_Jeremy_Lab3c_Rectangle.h"
#include "Thompson_Jeremy_Lab3c_Rectangle.h" // ifndef test
...
int main()
{
  ...
  cout << "Lab 3c, The \"RectangleDriver\" Program \n";
  ...
  
  {
    ...
    cout << "\n---Float---" << endl;
    cout << "Rectangle copy = rectangle. Object copy testing." << endl;
    cout << "Expect length of 5.1" << endl;
    cout << "Actual length: " << a.getLength() << endl;
    cout << "Expect width of 10.2" << endl;
    cout << "Actual width: " << a.getWidth() << endl;
    ...
    
  {
    ...
    cout << "\n---Float---" << endl;
    cout << "Rectange copy; copy = rectangle. Object assignment testing." << endl;
    cout << "Expect length of 5.1" << endl;
    cout << "Actual length: " << a.getLength() << endl;
    cout << "Expect width of 10.2" << endl;
    cout << "Actual width: " << a.getWidth() << endl;
